...
import fastcampus.bigfive.adapters.EvaluationServiceAdapter;
...
public class TestRestController {
    ...
    public EvaluationResult test(@RequestBody LinePoints linePoints) {
        // 성격 평가
        var evaluation = evaluationServiceAdapter.evaluate(linePoints);

        // Commentary Service로 해설 요청
        var commentaryRequest = CommentaryRequest.builder()
            .evaluationId(Long.valueOf(evaluation.getId()))
